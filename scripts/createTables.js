...
const createTables = async () => {
  const names = [config.AMAZON.DYNAMODB_COUNTRY_TABLE, config.AMAZON.DYNAMODB_EDUCATIONAL_INSTITUTION_TABLE,
    'test_' + config.AMAZON.DYNAMODB_COUNTRY_TABLE, 'test_' + config.AMAZON.DYNAMODB_EDUCATIONAL_INSTITUTION_TABLE]
